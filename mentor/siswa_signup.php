...
// Ambil nama divisi dari mentor yang login
$divisionName = $mentor['nama_divisi'];
$loggedInUserDivision = $mentor['divisi_id'];
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["signup"])) {
    ...
    if ($stmt->execute()) {
        ...
        $stmt->bind_param("issssiss", $user_id, $nama, $nim, $no_telephone, $alamat, $loggedInUserDivision, $jenis_kelamin, $instansi);
